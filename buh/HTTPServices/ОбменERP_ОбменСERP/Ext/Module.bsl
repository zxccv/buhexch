...
Процедура ЗагрузитьКомплектацииНоменклатуры(структураДокумент, ОписаниеОшибок, ЗапрашиваемыеОбъекты)    
	...
	Для Каждого структураСтрока Из структураДокумент.Товары Цикл
		...
		ТаблицаОперацииБух = Новый ТаблицаЗначений; 
		ТаблицаОперацииБух.Колонки.Добавить("НоменклатураОприходование", Новый ОписаниеТипов("СправочникСсылка.Номенклатура"));
		ТаблицаОперацииБух.Колонки.Добавить("Номенклатура", Новый ОписаниеТипов("СправочникСсылка.Номенклатура"));
		ТаблицаОперацииБух.Колонки.Добавить("Количество", Новый ОписаниеТипов("Число"));
		ТаблицаОперацииБух.Колонки.Добавить("СчетУчета", Новый ОписаниеТипов("ПланСчетовСсылка.Хозрасчетный"));
...
Процедура ЗагрузитьОбъектПоСтруктуре(структураОбъект, ОписаниеОшибок, ЗапрашиваемыеОбъекты)
	...
	ИначеЕсли структураОбъект.ТипОбъекта = "ПересортицаТоваров" Тогда
