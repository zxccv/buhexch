...
Процедура ВыгрузитьСтатьюРасходов(СсылкаНаОбъект, ОбъектИзменен, ТаблицаВыгрузки, ОписаниеОшибок)
	...
	ИначеЕсли СсылкаНаОбъект.ВариантРаспределенияРасходовРегл = Перечисления.ВариантыРаспределенияРасходов.НаСебестоимостьТоваров Тогда 
		СтруктураВыгрузки.Вставить("ТипОбъекта", "СтатьяЗатрат");
		СтруктураВыгрузки.Вставить("ВидРасходовНУ", "ТранспортныеРасходы");		
...
Процедура ВыгрузитьПриобретение(СсылкаНаОбъект, ОбъектИзменен, ТаблицаВыгрузки, ОписаниеОшибок)
	...
	Для Каждого стрТовары Из СсылкаНаОбъект.Товары Цикл
		...
		Если структураСтрокаТовары.ЭтоУслуга 
			И стрТовары.СписатьНаРасходы
			И стрТовары.СтатьяРасходов.ВариантРаспределенияРасходовРегл = Перечисления.ВариантыРаспределенияРасходов.НаСебестоимостьТоваров Тогда  
