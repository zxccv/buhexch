...
Процедура ВыгрузитьПриобретение(СсылкаНаОбъект, ОбъектИзменен, ТаблицаВыгрузки, ОписаниеОшибок)
	...
	Иначе
		ВыгрузитьПриобретениеКакПриобретение(СсылкаНаОбъект, ОбъектИзменен, ТаблицаВыгрузки, ОписаниеОшибок);
	КонецЕсли;
	
КонецПроцедуры

Процедура ВыгрузитьПриобретениеКакПриобретение(СсылкаНаОбъект, ОбъектИзменен, ТаблицаВыгрузки, ОписаниеОшибок)
...
Процедура ВыгрузитьПриобретениеКакАвансовыйОтчет(СсылкаНаОбъект, ОбъектИзменен, ТаблицаВыгрузки, ОписаниеОшибок)
...
Функция ВыполнитьЗапросКСервису(Узел, Команда, ТаблицаВыгрузки, ТипЗапроса = "POST", ЛогинПароль = Неопределено, НомерОтправляемого) Экспорт
	...
	HTTPСоединение = Новый HTTPСоединение(Узел.УРЛСервиса, , ЛогинПароль.Логин, ЛогинПароль.Пароль, , 240);
